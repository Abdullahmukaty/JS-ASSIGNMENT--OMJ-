...
for (let i = 0; i < products.length; i++) {
    ...
    let productelement = `
        <div class="lg:w-1/4 md:w-1/2 p-4 w-full border">
            ...
            <div class='flex justify-between items-center w-full'>
                ...
                <button onclick="colorthis(this)"><img class="w-5 fill-red-100" src="heart.svg" alt="favourite"></button>
                <button onclick="addToCart(this)" class='btn outline border-primary px-6'>Add</button>
            </div>
        </div>`;
